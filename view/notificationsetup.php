...
<head>        
        <!-- meta section -->
        <title>Boss Trader - Notification setup</title>
                ...
                <div class="dev-page-content">                    
                    ...
                    <div class="container">
                        ...
                        <div class="page-title">
                            ...
                            <p>Enter number of days for notification</p>
                        ...
                        <div class="wrapper wrapper-white">
                            <?php if ( $_SESSION['notSet'] == 1 ): ?>
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    Notification is set!
                                </div>
                           <?php unset($_SESSION['notSet']); endif; ?>
                            <?php if ( $_SESSION['notSet'] == 0 && isset($_SESSION['notSet']) ): ?>
                           ...
                           <?php unset($_SESSION['notSet']); endif; ?>
                            ...
                            <form method="post" action="notificationsetup" >
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-custom">
                                        <label>Notify me when my stock goes below: </label>
                                        <input type="text" name="notValue" class="form-control" value="10"/>                                            
                                    </div>                        
                                </div>
                            </div>
