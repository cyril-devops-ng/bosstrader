                ...
                <div class="dev-page-content">                    
                    ...
                    <div class="container">
                        ...
                        <div class="wrapper wrapper-white">
                           ...
                           <?php unset($_SESSION['complain_sent']); endif; ?>
                            <?php if ( $_SESSION['complain_sent'] == 0 && isset($_SESSION['complain_sent']) ): ?>
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <strong>Your complain was received! We will get back to you shortly.
                                </div>
                           <?php unset($_SESSION['complain_sent']); endif; ?>
                            ...
                            <form class="form-horizontal" method="POST" action="customerservice">
