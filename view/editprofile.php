                            ...
                            <div class="row row-wider">
                                <div class="col-md-3">
                                    <div class="profile margin-bottom-0">
                                        <div class="profile-image">
                                            <img id="profilepic" src="assets/images/users/<?= $_SESSION['company'][0]['company_id']?>_user_1.jpg">
                                            <div class="profile-badges">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-group-custom">
                                                    <label>Boss Username: </label>
                                                    <input type="text" name='bossUser' class="form-control" value="<?= $companyProfile[0]['boss_user'] ?>"/>                                            
                                                </div>                        
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-group-custom">
                                                    <label>Boss Password:</label>
                                                    <input type="password" name = 'bossPass' class="form-control" value="<?= $companyProfile[0]['boss_password'] ?>"/>                                            
                                                </div>                        
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-group-custom">
                                                    <label>Re-Password:</label>
                                                    <input type="password" name="bossRepass" class="form-control" value="<?= $companyProfile[0]['boss_password'] ?>"/>                                            
                                                </div>                        
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-group-custom">
                                                    ...
                                                    <input type="text" name="phoneNo"class="form-control" value="<?= $companyProfile[0]['phone_no'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group form-group-custom">
                                                    <label>Email:</label>
                                                    <input type="text" name="email"class="form-control" value="<?= $companyProfile[0]['email'] ?>"/>
                                                </div>
                                            </div>
                                        </div>                                                              
                                    </div>
